...
@Component({
  selector: 'user-sold-products-list',
  standalone: true,
  imports: [
    CommonModule,
    JichiTableComponent,
  ...
  templateUrl: './user-sold-products-list.component.html',
  styleUrls: ['./user-sold-products-list.component.scss']
})
export class UserSoldProductsListComponent implements OnInit {
